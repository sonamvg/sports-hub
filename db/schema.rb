...
ActiveRecord::Schema[8.1].define(version: 2026_09_23_173010) do
  ...
  create_table "super_admin_notifications", force: :cascade do |t|
    t.bigint "actor_id"
    t.datetime "created_at", null: false
    t.datetime "dismissed_at"
    ...
    t.integer "status", default: 0, null: false
    t.datetime "updated_at", null: false
    t.index ["actor_id"], name: "index_super_admin_notifications_on_actor_id"
    t.index ["dismissed_at"], name: "index_super_admin_notifications_on_dismissed_at"
    t.index ["kind", "status"], name: "index_super_admin_notifications_on_kind_and_status"
    t.index ["notifiable_type", "notifiable_id"], name: "index_super_admin_notifications_on_notifiable"
    t.index ["reviewed_by_id"], name: "index_super_admin_notifications_on_reviewed_by_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "phone"
    t.boolean "placeholder_email", default: false, null: false
    t.string "profile_photo_url"
    t.integer "role", default: 0, null: false
    t.datetime "updated_at", null: false
