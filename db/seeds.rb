...
athletes = [
  ...
  seed_athlete(
    ...
    first_name: "Vihaan",
    last_name: "Mehta",
    date_of_birth: Date.new(2013, 6, 15),
    gender: "male",
    belt: "blue",
    weight: 39.2,
    blood_group: "B+",
...
open_categories = %w[kyorugi-cadet-female-33-37 kyorugi-cadet-male-37-41 kyorugi-junior-male-51-55 individual-poomsae-female-cadet].map do |key|
